        ...
        <div className="content-box">
          ...
          {product && !loading && !error && (
            <div className="detail-box">
              <div className="mb-1">
                <span className="detail-content">ID:</span> {product.id}
              </div>
              <div className="mb-1">
                <span className="detail-content">Produto::</span> {product.name}
              </div>
              <div className="mb-1">
                <span className="detail-content">Slug:</span> {product.slug}
              </div>
              <div className="mb-1">
