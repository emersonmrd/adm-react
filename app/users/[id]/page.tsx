        ...
        <div className="content-box">
          ...
          {user && !loading && !error && (
            <div className="detail-box">
              <div className="mb-1">
                <span className="detail-content">ID:</span> {user.id}
              </div>
              <div className="mb-1">
                <span className="detail-content">Nome:</span> {user.name}
              </div>
              <div className="mb-1">
                <span className="detail-content">Email: </span>
                {user.email}
              </div>
              <div className="mb-1">
                <span className="detail-content">Situation: </span>{" "}
